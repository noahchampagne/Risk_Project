...
def inititalPhase_keyPressed(app, event):
    if event.key == 'p':
        for i in range(app.players):
            if i == 0:
                app.player1.countriesOwned[0].troops += app.player1.troopsToPlace
                app.player1.troopsToPlace = 0
            if i == 1:
                app.player2.countriesOwned[0].troops += app.player2.troopsToPlace
                app.player2.troopsToPlace = 0
            if i == 2:
                app.player3.countriesOwned[0].troops += app.player3.troopsToPlace
                app.player3.troopsToPlace = 0
            if i == 3:
                app.player4.countriesOwned[0].troops += app.player4.troopsToPlace
                app.player4.troopsToPlace = 0
...
def stage1_keyPressed(app, event):
    if event.key == 'k':
        app.player1.countriesOwned = []
        app.player2.countriesOwned = []
        app.player3.countriesOwned = []
        app.player4.countriesOwned = []
        for country in app.countryDictionary:
            countryObject = app.countryDictionary[country]
            if countryObject.name == 'North Africa':
                countryObject.owner = 2
                app.player2.countriesOwned.append(countryObject)
                continue
            countryObject.owner = 1
            app.player1.countriesOwned.append(countryObject)
        ...
        app.player4.troopsToPlace = 0
        app.playerIndex = 0
        app.currentplayer = app.playerList[app.playerIndex]
        app.players = 2
        app.mode = 'stage2'
